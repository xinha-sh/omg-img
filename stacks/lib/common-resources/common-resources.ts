...
import { addCfnCondition } from "../utils/index.js";
import { SolutionConstructProps } from "../types.js";
import { CustomResourcesConstruct } from "./custom-resources/custom-resource-construct.js";
...
export class CommonResources extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CommonResourcesProps) {
    ...
    this.conditions = {
      enableSignatureCondition: new CfnCondition(
        this,
      ...
      enableDefaultFallbackImageCondition: new CfnCondition(
        this,
        "EnableDefaultFallbackImageCondition",
        {
          expression: Fn.conditionEquals(
            props.enableDefaultFallbackImage,
            "Yes"
          ),
        }
      ),
    ...
    addCfnCondition(
      this.secretsManagerPolicy,
      this.conditions.enableSignatureCondition
    );

    this.customResources = new CustomResourcesConstruct(
      this,
      "CustomResources",
      {
