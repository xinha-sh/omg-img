...
export interface SendMetricsRequestProperties
  extends CustomResourceRequestPropertiesBase {
...
export interface PutConfigRequestProperties
  extends CustomResourceRequestPropertiesBase {
...
export interface CopyS3AssetsRequestProperties
  extends CustomResourceRequestPropertiesBase {
  ManifestKey: string;
...
export interface CheckSourceBucketsRequestProperties
  extends CustomResourceRequestPropertiesBase {
  SourceBuckets: string;
}

export interface CheckSecretManagerRequestProperties
  extends CustomResourceRequestPropertiesBase {
  SecretsManagerName: string;
  SecretsManagerKey: string;
}

export interface CheckFallbackImageRequestProperties
  extends CustomResourceRequestPropertiesBase {
...
export interface CreateLoggingBucketRequestProperties
  extends CustomResourceRequestPropertiesBase {
  BucketSuffix: string;
}
